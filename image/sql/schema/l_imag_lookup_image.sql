...
CREATE INDEX {$dbName}_business_image_image_id_index ON {$dbName}.lookup_business_image (image_id);
...
CREATE INDEX {$dbName}_user_image_image_id_index ON {$dbName}.lookup_user_image (image_id);
...
CREATE INDEX {$dbName}_comment_image_image_id_index ON {$dbName}.lookup_comment_image (image_id);
